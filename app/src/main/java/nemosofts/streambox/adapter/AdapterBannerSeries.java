...
public class AdapterBannerSeries extends RecyclerView.Adapter<AdapterBannerSeries.MyViewHolder> {

    private static final String TAG = "AdapterSeriesBanner";
    private final List<ItemSeries> arrayList;
    private final int columnWidth;
    private final int columnHeight;
    private final RecyclerItemClickListener listener;

    public AdapterBannerSeries(Context context, List<ItemSeries> arrayList, RecyclerItemClickListener listener) {
