...
public class OneUIActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(OneUIActivity.this);
    ...
    private void setListenerHome() {
        findViewById(R.id.iv_notifications).setOnClickListener(v -> startActivity(new Intent(OneUIActivity.this, NotificationsActivity.class)));
        findViewById(R.id.iv_file_download).setOnClickListener(v -> startActivity(new Intent(OneUIActivity.this, DownloadActivity.class)));
        findViewById(R.id.iv_profile).setOnClickListener(v -> startActivity(new Intent(OneUIActivity.this, ProfileActivity.class)));
        findViewById(R.id.iv_profile_re).setOnClickListener(v -> signOut());
        findViewById(R.id.iv_settings).setOnClickListener(v -> startActivity(new Intent(OneUIActivity.this, SettingActivity.class)));
    ...
    private void selectMovie() {
        if (spHelper.getCurrent(Callback.TAG_MOVIE).isEmpty()) {
            ...
            Intent intent = new Intent(OneUIActivity.this, MovieActivity.class);
    ...
    private void selectLive() {
        if (spHelper.getCurrent(Callback.TAG_TV).isEmpty()) {
            ...
            Intent intent = new Intent(OneUIActivity.this, LiveTvActivity.class);
    ...
    private void getSeries() {
        if (!NetworkUtils.isConnected(this)){
            pbSerials.setVisibility(View.GONE);
            Toasty.makeText(OneUIActivity.this,true, getString(R.string.err_internet_not_connected), Toasty.ERROR);
            return;
        }
    ...
    private void handlerSeriesEnd(String success, String msg) {
        if (success.equals("1")) {
            ...
            pbSerials.setVisibility(View.GONE);
            if (success.equals("3")){
                Toasty.makeText(OneUIActivity.this,true, msg, Toasty.ERROR);
            } else {
    ...
    public int setContentViewID() {
        return R.layout.activity_themes_one_ui;
    }
