...
public class VUIActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(VUIActivity.this, true);
        ...
        if (spHelper.isLogged()){
            ...
            String expDate = getString(R.string.expiration)+" "+ FormatUtils.convertIntToDate(spHelper.getExpDate(), "MMMM dd, yyyy");
    ...
    private void setListenerHome() {
        findViewById(R.id.iv_notifications).setOnClickListener(v -> startActivity(new Intent(VUIActivity.this, NotificationsActivity.class)));
        findViewById(R.id.iv_file_download).setOnClickListener(v -> startActivity(new Intent(VUIActivity.this, DownloadActivity.class)));
        findViewById(R.id.iv_profile_re).setOnClickListener(v -> signOut());
        findViewById(R.id.iv_profile).setOnClickListener(v -> startActivity(new Intent(VUIActivity.this, ProfileActivity.class)));
        findViewById(R.id.iv_settings).setOnClickListener(v -> startActivity(new Intent(VUIActivity.this, SettingActivity.class)));
    ...
    private void selectMovie() {
        if (spHelper.getCurrent(Callback.TAG_MOVIE).isEmpty()) {
            ...
            Intent intent = new Intent(VUIActivity.this, MovieActivity.class);
    ...
    private void selectLive() {
        if (spHelper.getCurrent(Callback.TAG_TV).isEmpty()) {
            ...
            Intent intent = new Intent(VUIActivity.this, LiveTvActivity.class);
    ...
    private void getSeries() {
        if (!NetworkUtils.isConnected(this)){
            pbSerials.setVisibility(View.GONE);
            Toasty.makeText(VUIActivity.this,true, getString(R.string.err_internet_not_connected), Toasty.ERROR);
            return;
        }
    ...
    private void handlerSeriesEnd(String success, String msg) {
        if (success.equals("1")) {
            ...
            pbSerials.setVisibility(View.GONE);
            if (success.equals("3")){
                Toasty.makeText(VUIActivity.this,true, msg, Toasty.ERROR);
            } else {
    ...
    public int setContentViewID() {
        return R.layout.activity_themes_v_ui;
    }
