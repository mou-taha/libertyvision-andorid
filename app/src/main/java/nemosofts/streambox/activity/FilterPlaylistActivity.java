...
public class FilterPlaylistActivity extends AppCompatActivity {
    ...
    private void initializeUI() {
        ...
        progressDialog = new ProgressDialog(FilterPlaylistActivity.this);
        ...
        findViewById(R.id.btn_filter).setOnClickListener(v -> DialogUtil.filterDialog(this, 1, () ->
    ...
    private void getDataCat() {
        new GetCategory(this, GetCategory.PAGE_TYPE_PLAYLIST_4, new GetCategoryListener() {
            @Override
            public void onStart() {
                progressDialog.show();
            }
            ...
            public void onEnd(String success, ArrayList<ItemCat> itemCat) {
                ...
                if (success.equals("1")) {
                    if (itemCat.isEmpty()) {
                        ...
                        selectCatName = itemCat.get(0).getName();
    ...
    private void getData() {
        loadLive = new GetChannelPlaylist(this, page, selectCatName, new GetChannelListener() {
            @Override
            public void onStart() {
    ...
    public void setAdapterToCatListview() {
        ...
        selectCatName = arrayListCat.get(0).getName();
        pos = 0;
    ...
    private void recreateData(int position) {
        if (!arrayListCat.isEmpty() && position < arrayListCat.size()) {
            pos = position;
            selectCatName = arrayListCat.get(position).getName();
